...
- **[animus](https://github.com/AreteDriver/animus)** — The AI operating environment these skills target
- **[mcp-manager](https://github.com/AreteDriver/mcp-manager)** — MCP server lifecycle manager (`pip install arete-mcp`)
- **[the-human-stack](https://github.com/AreteDriver/the-human-stack)** — The methodology reference that governs skill design
